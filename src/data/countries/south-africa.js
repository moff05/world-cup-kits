export const southAfrica = {
  ...
  "kits": {
      ...
      "kits": {
        "home": {
          ...
          "annotations": [
            ...
            {
              "id": "troussier-takes-over",
              "label": "A COACH PARACHUTED IN",
              "story": "Under caretaker Jomo Sono, the team had just reached the AFCON final in January 1998 when the federation handed the World Cup job to newly appointed Frenchman Philippe Troussier instead. Troussier's Bafana Bafana lost 3–0 to hosts France in the opener, never recapturing the momentum Sono had built."
            }
          ]
        }
      }
      ...
      "kits": {
        "home": {
          ...
          "annotations": [
            ...
            {
              "id": "missed-2006-return-2010",
              "label": "THE LONG WAY BACK",
              "story": "This early exit was not the end of the story so much as the start of an eight-year gap: South Africa failed to qualify for 2006, edged out by Ghana and DR Congo in a brutal CAF group. The country would not play another World Cup match until hosting the tournament itself in 2010."
            }
          ]
        }
      }
      ...
      "kits": {
        "home": {
          ...
          "annotations": [
            ...
            {
              "id": "vuvuzela-nation",
              "label": "VUVUZELA NATION",
              "story": "Stadiums buzzed at a constant roar measured near 127 decibels, louder than a referee's whistle, as fans blew plastic vuvuzela horns through every match. Visiting players complained they couldn't hear teammates or sleep in their hotels; FIFA let the noise stand in 2010, then banned the horns from the next World Cup entirely."
            }
          ]
        }
      }
    ...
    "2026": {
      "result": "Round of 32",
      "headline": "Bafana Bafana's Historic Breakthrough",
      "homeColors": "yellow shirt with green trim on the collar, shoulders and sleeve cuffs, tonal graphic pattern, green shorts with yellow stripes, yellow socks (adidas)",
      "awayColors": "deep green shirt with white fold-over collar and gold Three Stripes on the shoulders, white shorts, white socks (adidas)",
      "matches": [
        {
          "round": "Group Stage",
          "opponent": "Mexico",
      ...
      "kits": {
        "home": {
          ...
          "annotations": [
            {
              "id": "eustaquio-stunner-2026",
              "label": "THE KEY MOMENT",
              "story": "Deep into stoppage time in the Round of 32, Stephen Eustaquio chested down a bouncing ball and rifled it into the bottom corner in the 90+2nd minute, the only goal in an error-strewn game against co-host Canada. Sixteen years after hosting the tournament, South Africa's best-ever World Cup run ended one match short of the last 16."
            },
            {
              "id": "eleven-languages-kit-2026",
              "label": "THE KIT",
              "story": "adidas built South Africa's 2026 home shirt as a callback to 2010: yellow base, green trim across the collar, shoulders and sleeve cuffs, with a tonal graphic threading through the fabric nodding to the country's eleven official languages. Green shorts and yellow socks complete a kit — the first from adidas since replacing longtime supplier Le Coq Sportif."
            },
            {
              "id": "three-red-cards-record-2026",
              "label": "THE CONTEXT",
              "story": "South Africa's opener against Mexico produced three red cards — Yaya Sithole and Themba Zwane both dismissed for the visitors, César Montes late for the hosts — smashing the previous World Cup-opener record of two, set by Cameroon in 1990. Somehow, Bafana Bafana regrouped from that chaotic 2–0 defeat to reach the knockout stage for the first time in history."
            }
          ]
        }
      }
