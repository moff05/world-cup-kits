    ...
    "1930": {
      ...
      "kits": {
        "home": {
          ...
          "annotations": [
            {
              "id": "subiabre-penalty-then-winner",
              "label": "MISS, THEN MATCH-WINNER",
              "story": "Guillermo Subiabre stepped up against France and put his penalty wide — the first missed spot-kick in World Cup history. Ten minutes later he atoned, poking home the goal that beat France 1–0 and kept the campaign alive, redemption arriving inside the same half as the mistake."
            },
            {
              "id": "gath-chaves-beige-kit",
              "label": "BUTTONED UP IN BEIGE",
              "story": "No scarlet yet. In Montevideo, Chile played in a long-sleeved, button-collared shirt in plain brown-beige wool, stitched by Gath & Chaves — an Argentine department store that outfitted rival federations too. Function over identity: the famous red 'La Roja' look was still two decades from being invented."
            },
            {
              "id": "three-week-boat-crossing",
              "label": "THE THREE-WEEK CROSSING",
              "story": "FIFA's first World Cup landed in Montevideo partly because Uruguay agreed to cover travel costs and had just won consecutive Olympic golds. Most European federations balked at a three-week transatlantic crossing, leaving a field stacked with South American sides — Chile among thirteen teams gambling a ship voyage on history."
            }
          ]
        }
      }
    ...
    "2010": {
      ...
      "kits": {
        "home": {
          ...
          "annotations": [
            {
              "id": "gonzalez-seals-knockouts",
              "label": "KNOCKOUTS AGAIN UNDER BIELSA",
              "story": "Mark González's strike beat Switzerland 1–0, following an opening win over Honduras, and sent Chile into the second round for the first time in twelve years. Marcelo Bielsa's relentless, high-press system had turned a modest qualifying campaign into the most entertaining Chilean side in a generation — undone soon after by a 3–0 loss to Brazil."
            },
            {
              "id": "february-2010-earthquake",
              "label": "A COUNTRY STILL SHAKING",
              "story": "Just over three months before the opening match, an 8.8-magnitude earthquake — one of the strongest ever recorded — killed more than five hundred people and flattened towns across central Chile. The team's run to the knockout stage became something bigger than football: a rare piece of good news for a country still clearing rubble back home."
            },
            {
              "id": "brooks-kit-sponsor",
              "label": "BROOKS ON THE BADGE",
              "story": "While rivals wore Nike or Adidas, Chile's shirt in South Africa carried the name of Brooks — a company better known worldwide for running shoes than football kits. The red home jersey, blue shorts and white socks stayed traditional; the branding was the outlier, a regional supplier stepping in where the usual global giants hadn't bothered to bid."
            }
          ]
        }
      }
    ...
    "2014": {
      ...
      "kits": {
        "home": {
          ...
          "annotations": [
            {
              "id": "jara-penalty-post",
              "label": "JARA HITS THE POST",
              "story": "Alexis Sánchez had just canceled out Brazil's opener to force extra time in the Round of 16, but the shootout turned on Gonzalo Jara's spot-kick — struck true enough, only to cannon back off the post. Brazil converted theirs, Chile didn't, and a 3–2 shootout defeat closed one of the most gutting exits in the country's World Cup history."
            },
            {
              "id": "fans-storm-maracana",
              "label": "FANS STORM THE MARACANÃ",
              "story": "Hours before Chile faced defending champions Spain at the Maracanã, more than a hundred ticketless Chilean fans broke through a gate and flooded the media center, smashing glass doors and overturning furniture before security dragged roughly ninety of them out. Chile then went out and beat Spain 2–0 anyway, eliminating the champions from their own title defense."
            },
            {
              "id": "puma-collar-trim",
              "label": "PUMA'S COLLAR DETAIL",
              "story": "Puma's cut kept the familiar scarlet body but added a crisp white trim around the collar and cuffs, with the blue shorts picking up the same piping — a tidier, more tailored shirt than the boxier designs of the 2000s. Sánchez wore it to score in three straight matches, the best run of individual form the shirt had seen in years."
            }
          ]
        }
      }
