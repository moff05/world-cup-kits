export const bulgaria = {
  ...
  "facts": [
    {
      "id": "trikolyorite",
      "label": "BORN FROM THE FLAG",
      "story": "Bulgaria's white shirt, green shorts, and red socks trace directly to the national flag, giving the team its second nickname — Trikolyorite, the Tricolors — alongside 'The Lions,' a nod to the beasts guarding the national coat of arms. The federation ran its own kit production until 1974, when Adidas took over: a partnership that lasted twenty years, through the golden generation's 1994 run, before Puma became supplier in 1995, with the tricolor identity carried into the new era."
    },
    {
      "id": "five-cups-zero-wins",
      "label": "FIVE CUPS, ZERO WINS",
      "story": "Bulgaria reached five World Cups — 1962, 1966, 1970, 1974, and 1986 — without winning a single match, drawing six and losing ten across sixteen games. The breakthrough finally came in 1994, sparked by Emil Kostadinov's stoppage-time strike in Paris that eliminated France from qualifying. Once at the tournament, Bulgaria beat Greece and Argentina before knocking out Germany, turning two decades of World Cup futility into a run to the semi-finals."
    }
  ],
  "kits": {
    "1962": {
      "result": "Group Stage",
      "headline": "No Wins in Chile",
      "homeColors": "white shirt, green shorts, red socks",
      "awayColors": null,
      "matches": [
        {
          "round": "Group Stage",
    ...
    "1966": {
      ...
      "kits": {
        "home": {
          "image": "https://upload.wikimedia.org/wikipedia/commons/f/fd/Bulgaars_voetbalelftal_arriveert_op_Zestienhoven._Penev%2C_Yakimof%2C_Davigov%2C_Bestanddeelnr_922-8913.jpg",
          "imageCredit": {
            "player": "Dimitar Yakimov and teammates",
            "game": "Bulgaria squad arrival, Rotterdam, October 21 1969 — CC0 / Wikimedia Commons (Dutch National Archives / Anefo)"
          },
          "annotations": [
            {
    ...
    "1970": {
      "result": "Group Stage",
      "headline": "Winless Again in León",
      "homeColors": "white shirt, green shorts, red socks",
      "awayColors": null,
      "matches": [
        {
      ...
      "kits": {
        "home": {
          "image": "https://upload.wikimedia.org/wikipedia/commons/9/90/Bulgaars_voetbalelftal_arriveert_op_Zestienhoven._Links_Asparouchov_en_rechts_Si%2C_Bestanddeelnr_922-8916.jpg",
          "imageCredit": {
            "player": "Georgi Asparuhov, Simeon Simeonov",
            "game": "Bulgaria squad arrival, Rotterdam, October 21 1969 — CC0 / Wikimedia Commons (Dutch National Archives / Anefo)"
          },
          "annotations": [
            {
    ...
    "1974": {
      ...
      "kits": {
        "home": {
          "image": "https://upload.wikimedia.org/wikipedia/commons/d/d1/WK_74_Dortmund%2C_Nederland_tegen_Bulgarije_4-1_nr_16_vlnr_Rep%2C_Ivkov_en_Den%2C_Bestanddeelnr_927-2768.jpg",
          "imageCredit": {
            "player": "Kiril Ivkov, Georgi Denev",
            "game": "Netherlands v Bulgaria, Group Stage, June 23 1974 — CC0 / Wikimedia Commons (Dutch National Archives / Anefo)"
          },
          "annotations": [
            {
              "id": "legends-own-goal",
    ...
    "1986": {
      "result": "Round of 16",
      "headline": "Advancing Without a Win",
      "homeColors": "white shirt, green shorts, red socks (Adidas)",
      "awayColors": null,
      "matches": [
        {
          "round": "Group Stage",
      ...
      "kits": {
        "home": {
          "image": "https://upload.wikimedia.org/wikipedia/commons/0/04/Valdano_gol_bulgaria_86.jpg",
          "imageCredit": {
            "player": null,
            "game": "Argentina v Bulgaria, Group Stage, June 10 1986 — Public Domain / Wikimedia Commons (El Gráfico)"
          },
          "annotations": [
            {
    ...
    "1998": {
      "result": "Group Stage",
      "headline": "Second Straight Loss to Nigeria",
      "homeColors": "white shirt, green shorts, red socks (Puma)",
      "awayColors": null,
      "matches": [
        {
          "round": "Group Stage",
