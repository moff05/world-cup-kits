    ...
    "1934": {
      ...
      "kits": {
        "home": {
          ...
          "annotations": [
            {
              "id": "nejedlys-five-goals",
              "label": "NEJEDLÝ'S FIVE GOALS",
              "story": "Oldřich Nejedlý terrorized the tournament with five goals, three of them alone in a 3–1 semi-final demolition of Germany. In Rome's final, Antonín Puč's early strike had Czechoslovakia ahead until Raimundo Orsi's equalizer and Angelo Schiavio's extra-time winner handed the host nation the trophy, 2–1."
            },
            {
              "id": "a-young-tricolor",
              "label": "A YOUNG TRICOLOR",
              "story": "Czechoslovakia wore plain white shirts with red shorts and blue socks — no sponsor, no player names, just the national tricolor split across three garments, a design echoing a flag that had existed for barely sixteen years since the country's 1918 founding."
            },
            {
              "id": "football-under-il-duce",
              "label": "FOOTBALL UNDER IL DUCE",
              "story": "Mussolini's Italy hosted the tournament as a stage for Fascist prestige, and questions still surround the semi-final referee's performance against Czechoslovakia's opponents. The visiting Czechoslovaks reached the final anyway, only to lose to a host side that some contemporaries believed had been given every advantage the regime could arrange."
            }
          ]
        }
      }
    ...
    "1958": {
      ...
      "kits": {
        "home": {
          ...
          "annotations": [
            {
              "id": "the-biggest-win-and-a-playoff-loss",
              "label": "BIGGEST WIN, BITTER EXIT",
              "story": "Zdeněk Zikán and Václav Hovorka combined for four goals in a 6–1 rout of Argentina, Czechoslovakia's biggest-ever World Cup win, salvaging hope after a draw with West Germany. A playoff rematch with Northern Ireland, needed after both finished level, went to extra time and ended 2–1 — Zikán's goal not enough."
            },
            {
              "id": "two-decades-unchanged",
              "label": "TWO DECADES UNCHANGED",
              "story": "Sweden's cool 1958 climate suited the heavy wool-blend kit Czechoslovakia had worn for two decades; the white shirt and red shorts hadn't changed since before the war, even as football itself was entering the era of European club competition and televised matches."
            },
            {
              "id": "a-shared-screen",
              "label": "A SHARED SCREEN",
              "story": "Sweden 1958 was the first World Cup broadcast internationally on any real scale, meaning Czechoslovakia's win over Argentina and playoff defeat to Northern Ireland reached television screens across Communist and Western Europe alike — a rare shared moment across a continent otherwise divided by the Cold War."
            }
          ]
        }
      }
    ...
    "1970": {
      ...
      "kits": {
        "home": {
          ...
          "annotations": [
            {
              "id": "consolation-goals-only",
              "label": "CONSOLATION GOALS ONLY",
              "story": "Ladislav Petráš scored in back-to-back losses to Brazil and Romania in Guadalajara, but a 1–0 defeat to England in the finale sealed a winless exit. Pelé's Brazil, en route to a third title, proved simply too strong for a Czechoslovak side without its 1962 spark."
            },
            {
              "id": "dressed-for-autumn-in-summer",
              "label": "DRESSED FOR THE WRONG SEASON",
              "story": "Mexico's altitude and heat pushed several teams toward lighter kits in 1970, but Czechoslovakia's white-and-red remained largely traditional wool-cotton blends — a team still dressed for European autumns competing in Latin American summer conditions, the same uniform serving three very different matches."
            },
            {
              "id": "the-first-color-broadcast",
              "label": "THE FIRST COLOR BROADCAST",
              "story": "1970 was the first World Cup broadcast in color worldwide, meaning Czechoslovakia's white shirts appeared on television screens exactly as they looked in person for the first time — though a winless group stage meant few viewers outside Czechoslovakia had much reason to watch closely."
            }
          ]
        }
      }
    ...
    "1990": {
      ...
      "kits": {
        "home": {
          ...
          "annotations": [
            {
              "id": "the-best-run-in-decades",
              "label": "THE BEST RUN IN DECADES",
              "story": "Tomáš Skuhravý scored five goals including a hat-trick in a 4–1 rout of Costa Rica, carrying Czechoslovakia to the quarter-finals for the first time since 1962. Eventual champions West Germany ended the run 1–0 in Milan, but Skuhravý's Silver Boot marked the country's best World Cup in nearly three decades."
            },
            {
              "id": "the-last-united-kit",
              "label": "THE LAST UNITED KIT",
              "story": "Puma outfitted Czechoslovakia for Italia '90 in a redesigned white shirt with red-and-blue trim, a modernized take on the tricolor kit worn since the 1930s — the last kit the team would wear representing a united Czechoslovakia before the country split in two."
            },
            {
              "id": "newly-free-support",
              "label": "NEWLY FREE SUPPORT",
              "story": "Six months after the peaceful Velvet Revolution ended four decades of Communist rule, Czechoslovakia arrived in Italy as a newly free nation. Fans who'd previously needed permission and faced restrictions to travel abroad followed the team in numbers unseen for generations, turning away fixtures into genuine away support."
            }
          ]
        }
      }
    ...
    "2006": {
      ...
      "kits": {
        "home": {
          ...
          "annotations": [
            {
              "id": "an-independent-debut",
              "label": "AN INDEPENDENT DEBUT",
              "story": "Tomáš Rosický scored twice in a 3–0 opening win over the United States, the Czech Republic's first World Cup match as an independent nation. Losses to Ghana and Italy in Cologne and Hamburg sent the Czechs home after the group stage, their only appearance since the 1993 split still without a knockout match."
            },
            {
              "id": "seventy-years-of-white-ends",
              "label": "SEVENTY YEARS OF WHITE ENDS",
              "story": "Puma dressed the Czech Republic in red shirts with white trim for 2006 — the first World Cup kit built around red as the primary color rather than white, closing out the seventy-year white-shirt tradition the team had carried since 1934."
            },
            {
